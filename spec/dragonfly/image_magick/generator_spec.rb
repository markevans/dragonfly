...
describe Dragonfly::ImageMagick::Generator do
  ...
  describe "plain" do
    before(:each) do
      @generator = Dragonfly::ImageMagick::Generator::Plain.new
    end
  ...
  describe "plasma" do
    before(:each) do
      @generator = Dragonfly::ImageMagick::Generator::Plasma.new
    end
  ...
  describe "text" do
    before(:each) do
      @generator = Dragonfly::ImageMagick::Generator::Text.new
      @text = "mmm"
    end
