  ...
  module DataStorage
    ...
    class CloudfilesDataStore
      ...
      def url_for(uid, opts={})
        storage.get_object(directory, uid).public_url
      end
      ...
      def directory_exists?
        rescuing_socket_errors{ !storage.directories.detect{|d| d.key == directory }.nil? }
      rescue Excon::Errors::NotFound, Fog::Storage::Rackspace::NotFound => e
        false
      end
      ...
      def ensure_directory_initialized
        unless @directory_initialized
          rescuing_socket_errors{ storage.directories.create(:key => directory) } unless directory_exists?
